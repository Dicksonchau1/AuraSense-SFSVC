...
class DemoPDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 10,
                  f"Page {self.page_no()}/{{nb}} | www.aurasensehk.com | DicksonChau@aurasensehk.com",
                  align="C")
...
def build_pdf(video_path: str, output_path: str, recipient: str = "Wilson"):
    ...
    pdf.cell(0, 8, "www.aurasensehk.com  |  DicksonChau@aurasensehk.com",
             align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    steps = [
        ...
        "3. Schedule a live demo call - DicksonChau@aurasensehk.com",
